...
public class CCategoriesDomain {
	...
	private String p_category_id,p_category_name,c_update_date,sub_name,c_category_id,sub_id, c_category_name, subCat;
	...
	public String toString() {
		return "CCategoriesDomain [p_category_id=" + p_category_id + ", p_category_name=" + p_category_name
				...
				+ ", sub_id=" + sub_id + ", c_category_name=" + c_category_name + ", subCat=" + subCat + "]";
	}
