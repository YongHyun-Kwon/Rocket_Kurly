        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div style="padding-left: 50px ;width: 950px">
                    ...
                    <div class="card">
                        <label style="font-size: 20px;margin-left: 20px" for="html5-text-input" class="col-md-2 col-form-label">발행 대상</label>
                    ...
                    <button style="margin-top: 30px;float: right" class="btn btn-dark">쿠폰 발행</button>
                </div>
                <!-- /중분류 -->
