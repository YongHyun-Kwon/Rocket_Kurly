        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div style="padding-left: 50px ;width: 950px">
                    <label style="font-size: 30px;font-weight: bold; padding-bottom: 30px">카테고리 수정</label>
                    <div class="mb-3 row">
                    ...
                    <button style="margin-top: 30px;float: right" class="btn btn-dark">카테고리 수정</button>
                </div>
                <!-- /중분류 -->
