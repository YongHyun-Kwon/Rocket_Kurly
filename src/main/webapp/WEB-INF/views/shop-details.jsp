                            ...
                            <div class="tab-pane" id="tabs-3" role="tabpanel">
                                <div class="product__details__tab__desc">
                                    ...
                                    <div class="intro">
										...
										<!--리뷰 테이블 틀  -->
										<table class="reviewTab" style="width: 100%; border: 0px; cellpadding:0px; cellspacing:0px;">
										...
										<tbody>
											<tr>
												<th scope="col" class="input_text">번호</th>
												<th scope="col" class="input_text">제목</th>
												<th scope="col" class="input_text">작성자</th>
												<th scope="col" class="input_text">작성일</th>
											</tr>
										</tbody>
										</table>
										<!--사용자 후기 테이블-->
